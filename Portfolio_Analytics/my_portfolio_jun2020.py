...
tickers = ['ICICIB22.NS', 'BOSCHLTD.NS', 'CANFINHOME.NS', 'CARERATING.NS', 'CROMPTON.NS', 'ELGIEQUIP.NS', 'ENGINERSIN.NS', 'IDEA.NS', 'IEX.NS', 'INFY.NS', 'IOLCP.NS', 'ITC.NS', 'LUPIN.NS', 'OCCL.NS', 'PVR.NS', 'SBICARD.NS', 'SUNDARMFIN.NS', 'ZEEL.NS', '^NSEI']
